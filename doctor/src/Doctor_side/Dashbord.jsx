                    ...
                    <table className="table table-bordered mt-4">
                        ...
                        <tbody>
                            {Array.isArray(data) && data.length > 0 ? (
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            {appointment.fees_paid ? (
                                                ...
                                                <span className="text-danger h6">Unpaid</span>
                                            )}
                                        </td>
                                        <td>
                                            <button
                                                onClick={() => {
                                                    if (appointment.fees_paid) {
                                                        updateStatus(appointment._id, 'approve');
                                                    } else {
                                                        alert("Appointment cannot be approved until payment is complete.");
                                                    }
                                                }}
                                                className="btn btn-success btn-sm mr-2"
                                                disabled={!appointment.fees_paid}
                                            >
                                                Approve
                                            </button>
                                ...
                                <tr>
                                    <td colSpan="5" className="text-center">No pending appointments</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
