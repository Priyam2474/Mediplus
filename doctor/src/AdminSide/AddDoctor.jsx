...
function AddDoctor() {
  ...
  const doctor = (e) => {
    ...
    axios
      .post("http://localhost:5000/api/doctor/add", formData, {
  ...
  return (
    <div className="d-flex">
      ...
      <div className="mt-4">
        ...
        <div className="container mt-4  pt-3 shadow" style={{ marginLeft: "270px", backgroundColor: "white", boxShadow: "0 0 15px rgba(0,0,0,0.2)" }}>
