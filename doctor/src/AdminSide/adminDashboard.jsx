...
function AdminDashboard() {
    ...
    useEffect(() => {
    axios.get("http://localhost:5000/api/count/admin/dashboard-stats")
            .then((res) => {
                const data = res.data;
                setStats([
                    ...
                    { title: "Medicine Orders", value: data.medicines, icon: "bi bi-capsule", background: "bg-warning" },
            ...
            <div className="d-flex">
                ...
                <div className="container mt-3 pt-3" style={{ marginLeft: "250px" }}>
                    ...
                    <div className="container mt-4">
                                ...
                                <div className="col-md-3 mb-3" key={index}>
                                    <div className={`card h-100 shadow-sm text-dark ${stat.background}`} >
                                        <div className="card-body d-flex align-items-center">
                                            ...
                                            <div>
                                                <div className="h5 fw-bold">{stat.title}</div>
                        ...
                        {Array.isArray(data) && [...data].reverse().slice(0, 4).map((app, index) => (
